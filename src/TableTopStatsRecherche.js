...
export default class TableTopStatsRecherche extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  render() {
    return (
      ...
      <TableHead>
            ...
            <TableCell></TableCell>
            <TableCell></TableCell>
            <TableCell align="center" colSpan="2"><span style={{fontVariantCaps:"all-small-caps"}}>GAGNANT / RDE.</span></TableCell>
            <TableCell align="center" colSpan="2"><span style={{fontVariantCaps:"all-small-caps"}}>PLACÉ / RDE.</span></TableCell>
        ...
        <TableBody>
                  ...
                  {(this.state.listeStats != null) && ( this.state.listeStats.map((s) => {
                          ...
                          return (
                            ...
                            <TableCell style={{width:"18px"}} align="left">
                            <Badge badgeContent={s.engagement} color="primary"><img width="25" height="25" src={chemin}/>
                            </Badge></TableCell>
                          <TableCell align="left">
                          <Tooltip arrow title={<h3><i><u>DTF CRITÈRES</u></i> ©<br/><br/>{s.requete}</h3>}>
                          <div>
        ...
        { (this.state.listeStats != null) && (this.state.listeStats.length == 0) && (
                      <Alert style={{marginTop:"1em"}} severity="info">Aucune statistiques trouvées.</Alert>
          ) }

        {(this.state.listeStats != null) && (this.state.listeStats.length >= 30) && (
                      <Alert style={{marginTop:"1em"}} severity="info">Afin de voir plus de sélections, merci d'affiner votre recherche.</Alert>
          ) }
        <SwipeableDrawer
          anchor="right"
