    ...
    },
    {
      ...
      options: {
        ...
        customBodyRender: (data,tableMeta) => {
          ...
          if(data == "D4"){
            return (
              <Tooltip arrow title={<h3>Déferré des 4 pieds</h3>}>
                <span>{data}</span>  
              </Tooltip>
            ...
            return (
              <Tooltip arrow title={<h3>Déferré des antérieurs</h3>}>
                <span>{data}</span>  
              </Tooltip>
            ...
            return (
              <Tooltip arrow title={<h3>Déferré des postérieurs</h3>}>
                <span>{data}</span>  
              </Tooltip>
      ...
      options: {
        ...
        customBodyRender: (data,tableMeta) => {
          ...
          if(musique == ""){
            ...
            return (
            <Tooltip arrow title={<h3>Gain du trotteur sur sa carriére</h3>}>
...

    {
      ...
      options: {
        ...
        if(data == ""){
          ...
          return (
            <Tooltip arrow title={<h3>Performances récentes du trotteur</h3>}>
               <span>{data}</span>  
             </Tooltip>
      ...
      options: {
        ...
        customBodyRender: (data,tableMeta) => {
           ...
           if(musique == "" || musique.includes('IN')){
            return (
              <Tooltip arrow title={<h3>Aucune donnée</h3>}>
