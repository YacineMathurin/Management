...
class TableHistoriqueEntraineur extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      apiKey : props.apiKey,
      synthese : this.props.synthese,
      nomEntraineur: this.props.entraineur,
    }
        ...
        },
        {
          ...
          options: {
            ...
            customBodyRender: (data, tableMeta) => {
              ...
              if(this.state.nomEntraineur == data){
                return (
                  <div style={{cursor:"pointer"}}>
...
export default TableHistoriqueEntraineur;
