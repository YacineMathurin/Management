...
const COLORS = ['#f2f2f2', '#3F51B5', '#354498'];

export default class TinyPieChartsTrio extends PureComponent {
  constructor(props) {
    super(props)
    const pctReussiteGagnant = this.props.reussiteGagnant
    const pctReussitePlace = this.props.reussitePlace
    this.state = {
      data: [{ value: 100 -   (pctReussitePlace + pctReussiteGagnant) },  { value: pctReussitePlace }, { value: pctReussiteGagnant }]
    }
  }
