...
class TableHistoriqueTrotteur extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      apiKey : props.apiKey,
      synthese : this.props.synthese,
      nomTrotteur: this.props.trotteur,
    }
        ...
        },
        {
          ...
          options: {
            ...
            customBodyRender: (data, tableMeta) => {
              ...
              if(this.state.nomTrotteur == data){
                return (
                  <div style={{cursor:"pointer"}}>
...
export default TableHistoriqueTrotteur;
